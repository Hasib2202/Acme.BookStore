...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p eb7b8581-25fe-4e02-afee-e4b090fb5f57
```

> `eb7b8581-25fe-4e02-afee-e4b090fb5f57` is the password of the certificate, you can change it to any password you want.
